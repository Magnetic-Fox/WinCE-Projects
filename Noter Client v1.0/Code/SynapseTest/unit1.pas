...
{ String table }
const questionUnsavedChanges=      'Czy chcesz porzucić niezapisane zmiany?';
const questionDeleteAccount=       'Czy na pewno chcesz usunąć swoje konto?'#13#10'Ten proces jest nieodwracalny!';
const questionChangeCredentials=   'Ponieważ serwer został zmieniony, obecne dane logowania są niepoprawne. Czy chcesz je zmienić?';
const questionUpdateNote=          'Czy na pewno chcesz zaktualizować tą notatkę?';
const questionDeleteNote=          'Czy na pewno chcesz usunąć tą notatkę?';
const questionWantLogout=          'Czy na pewno chcesz się wylogować?';

const informationPreviousServer=   'Poprzednie dane serwera zostały przywrócone';

const errorNoHelpFile=             'Plik pomocy nie został zainstalowany!';
const errorFillForms=              'Musisz wypełnić widoczne pola.';
const errorProvidePassword=        'Aby usunąć konto, musisz podać swoje hasło.';
const errorPasswordNotMatching=    'Hasła nie są takie same!';

const buttonAdd=	           'Dodaj';
const buttonUpdate=	           'Zaktualizuj';
const buttonLock=	           'Zablokuj';
const buttonUnlock=	           'Odblokuj';

const labelConnectionCheckError=   'Sprawdzanie połączenia... BŁĄD';
const labelConnectionCheckOK=	   'Sprawdzanie połączenia... OK';
const labelRegisteredSuccessfully= 'Pomyślnie zarejestrowano! :)';
const labelRegistrationError=	   'Nie udało się zarejestrować. :(';
const labelLoggedInSuccessfully=   'Pomyślnie zalogowano! :)';
const labelLoggingInError=	   'Nie udało się zalogować. :(';
const labelID=			   'ID: ';
const labelDate=		   'Data: ';

const errorWrongAnswer=            'Błędna odpowiedź serwera';
const errorServerShutdown=         'Serwer tymczasowo wyłączony';
const errorInternalServer=         'Wewnętrzny błąd serwera';
const errorNoteAlreadyUnlocked=    'Notatka już odblokowana';
const errorNoteAlreadyLocked=      'Notatka już zablokowana';
const errorNoteLocked=             'Notatka jest zablokowana';
const errorUserDelete=             'Błąd usuwania użytkownika';
const errorWrongUser=              'Użytkownik nie istnieje';
const errorWrongNote=              'Notatka nie istnieje';
const errorNoNeededData=           'Brak wymaganych informacji';
const errorUserLocked=             'Użytkownik jest zablokowany';
const errorWrongCredentials=       'Nieprawidłowe dane logowania';
const errorWrongCommand=           'Nieznane polecenie';
const errorNoCredentials=          'Brak danych logowania';
const errorUsernameTaken=          'Wybrana nazwa użytkownika jest zajęta';
const errorNoUsableData=           'Brak użytecznych informacji w żądaniu';
const errorWrongRequest=           'Nieprawidłowy typ żądania';
const errorUnknownCode=            'Nieznany kod odpowiedzi serwera';

const infoOK=                      'OK';

const infoUserCreated=             'Pomyślnie utworzono użytkownika';
const infoUserUpdated=             'Pomyślnie zaktualizowano użytkownika';
const infoUserDeleted=             'Pomyślnie usunięto użytkownika';
const infoNoteListGot=             'Pomyślnie odebrano listę notatek';
const infoNoteRetrieved=           'Pomyślnie odebrano notatkę';
const infoNoteCreated=             'Pomyślnie utworzono notatkę';
const infoNoteUpdated=             'Pomyślnie zaktualizowano notatkę';
const infoNoteDeleted=             'Pomyślnie usunięto notatkę';
const infoUserInfoGot=             'Pomyślnie odebrano informacje o użytkowniku';
const infoNoteLocked=              'Pomyślnie zablokowano notatkę';
const infoNoteUnlocked=            'Pomyślnie odblokowano notatkę';
const infoServerChanged=           'Pomyślnie zmieniono serwer';
